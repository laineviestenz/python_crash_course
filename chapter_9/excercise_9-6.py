...
#define jose's icecream stand
joses_ice_cream = IceCreamStand("Jose's Ice Cream", 'Ice Cream')
#show that the flavors defaulted to vanilla and chocolate
IceCreamStand.get_flavors(joses_ice_cream)
#change the flavors that are offered
IceCreamStand.update_flavors(joses_ice_cream, ['mint', 'cookies and cream'])
#print the flavors
IceCreamStand.get_flavors(joses_ice_cream)